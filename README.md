...
## 資料庫設計
依照功能需求規劃8張資料表，包含日記主表、一般日記表、心情日記表、情緒表、標籤表、日記標籤關聯表、心情日記情緒關聯表與媒體表，建立一對一、一對多與多對多關聯。
...
|       資料表       |           說明           |
|---|---|
| Diary              | 日記主表，存放共同欄位(使用者、日期、時間、天氣、分享狀態、發布狀態) |
| DiaryNormal        | 一般日記內容(標題、內容) |
| DiaryMood          | 心情日記內容(情緒多選、三個衡量分數、三個引導問題) |
| Mood               | 情緒選項 |
| Tag                | 系統標籤與使用者自訂標籤 |
...
### 日記列表
提供關鍵字搜尋、期間篩選、標籤篩選、模板篩選、分享狀態篩選與排序功能。

![日記列表](Screenshots/diary_list.png)

### 日記列表｜分享狀態篩選
查看自己已分享的日記資料，另外可到「分享牆」頁面觀看他人的分享日記。
